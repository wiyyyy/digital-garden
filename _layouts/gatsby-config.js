...
module.exports = {
  ...
  pathPrefix: PATH_PREFIX || `/digital-garden`, // b. If you are using Netlify/Vercel, your can keep it this way
  siteMetadata: {
    // some SEO configs using by gatsby-theme-kb
    title: `My Digital Garden`, // Replace it with your site's title
    author: `Ahmet AK`, // Replace it with your name
